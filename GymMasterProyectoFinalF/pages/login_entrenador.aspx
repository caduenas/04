<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login_entrenador.aspx.cs" Inherits="GymMasterProyectoFinalF.pages.login_entrenador" %>
    ...
    <form runat="server">
      <div class="form-group">
        <label for="username">Correo Electronico:</label>
          <asp:TextBox ID="correoEntrenador" runat="server" type="email" name="username" placeholder="Ingrese su usuario"></asp:TextBox>
