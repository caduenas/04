<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarEntrenadores.aspx.cs" Inherits="GymMasterProyectoFinalF.pages.OpcionesConsultar" %>
...
<body>
    <h1>Consulta de Entrenadores</h1>
    <form runat="server">
        <label for="nombre">Nombre Entrenador:</label>
