...
{
    public partial class ActualizarEntreandores : System.Web.UI.Page
    {
        ...
        protected void Actualizar_Click(object sender, EventArgs e)
        {
            ...
            string sql = @"UPDATE entrenadores SET nombre_entrenador = @nombre, correo_entrenador = @correo WHERE id_entrenador = @id";
