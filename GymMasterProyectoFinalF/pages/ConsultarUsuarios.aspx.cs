    ...
    public partial class Consultar : System.Web.UI.Page
    {
        ...
        protected void Busqueda_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = @"SELECT * FROM asesorados WHERE nombre_asesorado = @nombre AND correo_asesorado = @correo";
            ...
            if (reader.HasRows)
            {
                ...
                while (reader.Read())
                {
                    int idUsuario = (int)reader["id_asesorados"];
                    string nombrease = reader["nombre_asesorado"].ToString();
                    string apellido = reader["apellido_asesorado"].ToString();
                    string correo = reader["correo_asesorado"].ToString();
                    string numero = reader["numero_asesorado"].ToString();
