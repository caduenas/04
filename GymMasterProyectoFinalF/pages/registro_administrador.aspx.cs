...
namespace GymMasterProyectoFinalF.pages
{
    public partial class registro_administrador : System.Web.UI.Page
    {
        ...
        protected void botonIngresarR_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "INSERT INTO admins (nombre_admin, apellido_admin, contrasena_admin,  correo_admin, numero_admin) VALUES (@nombreC, @apellidoC, @contras, @correo, @telefono)";
                ...
                {
                    conn.Close();
                    Response.Redirect("Home_administrador.aspx"); // Redirige a otra_pagina.aspx después de un registro exitoso
